	...
	<% if (session.getAttribute("ruolo")==null){  
	  ...
	  <div class="jumbotron" >
	    <div class="container">
	      ...
	      <p><a class="btn btn-primary btn-lg" href="SearchCategoriaServlet" role="button">Cerca Categorie &raquo;</a></p>
	      <p><a class="btn btn-primary btn-lg" href="SearchArticoloServlet" role="button">Cerca Articoli &raquo;</a></p>
	    </div>
	  </div>
